const quizData = [
    ...
    { q: "A 54 year old is found lethargic with rapid, deep respirations, and high glucose. How should you manage this patient? ", options: ["Ventilate with PPV using a BVM to slow the respirations", "Open and secure the airway", "Hyperventilate the patient with a BVM", "Check the patient's pupils"], answer: ["Ovulation pain"], type: "single", category: "Ch 25: Gynecologic", section: "Medical", rationale: "Mittelschmerz is the sharp, localized pain felt during the middle of the menstrual cycle." }
