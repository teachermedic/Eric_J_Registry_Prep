...
{ q: "A patient in her 3rd trimester presents with painless, bright red vaginal bleeding. This is most likely:", options: ["Abruptio Placentae", "Placenta Previa", "Ectopic Pregnancy", "Preeclampsia"], answer: ["Placenta Previa"], type: "single", category: "Ch 35: OB", section: "OB/GYN & Pediatrics", rationale: "Placenta Previa is characterized by painless, bright red bleeding." },
{ q: "Which finding differentiates Eclampsia from Preeclampsia?", options: ["Hypertension", "Proteinuria", "Seizures", "Peripheral Edema"], answer: ["Seizures"], type: "single", category: "Ch 35: OB", section: "OB/GYN & Pediatrics", rationale: "Eclampsia is defined as the onset of seizures in a patient with preeclampsia." },
{ q: "During delivery, the infant's head emerges but the shoulders become stuck. This is known as:", options: ["Nuchal Cord", "Breech Presentation", "Shoulder Dystocia", "Prolapsed Cord"], answer: ["Shoulder Dystocia"], type: "single", category: "Ch 35: OB", section: "OB/GYN & Pediatrics", rationale: "Shoulder dystocia occurs when the fetal shoulders cannot pass the symphysis pubis." },
{ q: "What is the compression-to-ventilation ratio for neonatal resuscitation with two rescuers?", options: ["3:1", "15:2", "30:2", "5:1"], answer: ["3:1"], type: "single", category: "Ch 36: Neonatal", section: "OB/GYN & Pediatrics", rationale: "Neonatal resuscitation follows a 3:1 ratio (90 compressions and 30 breaths per minute)." },
{ q: "A newborn has a HR of 54 bpm after 30 seconds of effective positive pressure ventilation. What is your next action?", options: ["Administer Epinephrine", "Begin chest compressions", "Increase O2 concentration", "Continue PPV for another 30s"], answer: ["Begin chest compressions"], type: "single", category: "Ch 36: Neonatal", section: "OB/GYN & Pediatrics", rationale: "If HR is < 60 despite effective PPV, chest compressions must begin." },
{ q: "The 'Pediatric Assessment Triangle' (PAT) consists of which three elements? (Select all that apply)", options: ["Appearance", "Work of Breathing", "Circulation to Skin", "Blood Pressure"], answer: ["Appearance", "Work of Breathing", "Circulation to Skin"], type: "multiple", category: "Ch 37: Peds", section: "OB/GYN & Pediatrics", rationale: "PAT is a visual assessment of Appearance, Breathing, and Circulation." },
{ q: "A 3-year-old presents with a high fever, drooling, and is sitting in a 'tripod' position. You should suspect:", options: ["Croup", "Epiglottitis", "Asthma", "Bronchiolitis"], answer: ["Epiglottitis"], type: "single", category: "Ch 37: Peds", section: "OB/GYN & Pediatrics", rationale: "Drooling and tripod position are classic indicators of Epiglottitis, a life-threatening airway emergency." },
{ q: "An infant presents with a 'seal-bark' cough and low-grade fever. This is most indicative of:", options: ["Croup", "Epiglottitis", "Pneumonia", "Pertussis"], answer: ["Croup"], type: "single", category: "Ch 37: Peds", section: "OB/GYN & Pediatrics", rationale: "Croup (laryngotracheobronchitis) typically presents with a barking cough and stridor." },
{ q: "In an infant, a sunken fontanelle is a sign of:", options: ["Increased Intracranial Pressure", "Dehydration", "Meningitis", "Normal development"], answer: ["Dehydration"], type: "single", category: "Ch 37: Peds", section: "OB/GYN & Pediatrics", rationale: "Sunken fontanelles suggest severe dehydration and hypovolemia." },
{ q: "Upon assessment of a delivering mother, you see the umbilical cord protruding from the vagina. How should you manage this?", options: ["Pull the cord to speed delivery", "Place the mother in knee-chest position and elevate the hips", "Push the cord back into the vagina", "Clamp and cut the cord immediately"], answer: ["Place the mother in knee-chest position and elevate the hips"], type: "single", category: "Ch 35: OB", section: "OB/GYN & Pediatrics", rationale: "Prolapsed cord management requires taking pressure off the cord by positioning and manual displacement." }
];
