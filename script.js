const quizData = [
    ...
    { q: "Which of the following is a 'Mandatory Reporting' requirement for EMS in most states? (Select all that apply)", options: ["Child abuse", "Elder abuse", "Gunshot wounds", "Domestic violence"], answer: ["Child abuse", "Elder abuse", "Gunshot wounds", "Domestic violence"], type: "multiple", category: "Legal", section: "Foundations", rationale: "Most jurisdictions require reporting of these categories to protect vulnerable populations." },
    ...
    { q: "In a state of Acidosis, the heart becomes:", options: ["More sensitive to Epinephrine", "Less responsive to catecholamines", "Hyper-excitable", "More efficient at pumping"], answer: ["Less responsive to catecholamines"], type: "single", category: "Patho", section: "Pathophysiology", rationale: "Acidosis decreases myocardial contractility and makes the heart less responsive to catecholamines." },
    { q: "The Bicarbonate Buffer System manages pH by balancing which two components?", options: ["Oxygen and Nitrogen", "Carbon Dioxide and Bicarbonate", "Sodium and Potassium", "Calcium and Magnesium"], answer: ["Carbon Dioxide and Bicarbonate"], type: "single", category: "Patho", section: "Pathophysiology", rationale: "The body uses the lungs to regulate CO2 and the kidneys to regulate Bicarbonate." },

    // --- MEDICAL TERMINOLOGY ---
    { q: "Provide the medical term for 'a heart rate below 60 beats per minute.'", options: [], answer: ["Bradycardia"], type: "text", category: "Terminology", section: "Terminology", rationale: "Brady- (slow) + -cardia (heart)." },
    { q: "Provide the medical term for 'a heart rate above 100 beats per minute.'", options: [], answer: ["Tachycardia"], type: "text", category: "Terminology", section: "Terminology", rationale: "Tachy- (fast) + -cardia (heart)." },
    { q: "Provide the medical term for 'difficulty or labored breathing.'", options: [], answer: ["Dyspnea"], type: "text", category: "Terminology", section: "Terminology", rationale: "Dys- (difficult) + -pnea (breathing)." },
    { q: "Provide the medical term for 'the absence of breathing.'", options: [], answer: ["Apnea"], type: "text", category: "Terminology", section: "Terminology", rationale: "A- (without) + -pnea (breathing)." },
    ...
    { q: "Provide the medical term for 'enlargement of the liver.'", options: [], answer: ["Hepatomegaly"], type: "text", category: "Terminology", section: "Terminology", rationale: "Hepat- (liver) + -megaly (enlarged)." },
    { q: "Provide the medical term for 'inflammation of the gallbladder.'", options: [], answer: ["Cholecystitis"], type: "text", category: "Terminology", section: "Terminology", rationale: "Chole- (bile) + cyst- (sac) + -itis (inflammation)." },
    { q: "Provide the medical term for 'excessive sweating.'", options: [], answer: ["Diaphoresis"], type: "text", category: "Terminology", section: "Terminology", rationale: "Used often to describe clinical signs of shock or cardiac events." },
    { q: "Provide the medical term for 'blood in the chest cavity.'", options: [], answer: ["Hemothorax"], type: "text", category: "Terminology", section: "Terminology", rationale: "Hemo- (blood) + -thorax (chest)." },
    { q: "Provide the medical term for 'low levels of oxygen in the tissues.'", options: [], answer: ["Hypoxia"], type: "text", category: "Terminology", section: "Terminology", rationale: "Hypo- (low) + oxia (oxygen)." },
    { q: "Provide the medical term for 'bluish discoloration of the skin due to low oxygen.'", options: [], answer: ["Cyanosis"], type: "text", category: "Terminology", section: "Terminology", rationale: "Cyan- (blue) + -osis (condition)." },
    { q: "Provide the medical term for 'a new surgical opening in the stomach.'", options: [], answer: ["Gastrostomy"], type: "text", category: "Terminology", section: "Terminology", rationale: "Gastr- (stomach) + -stomy (new opening)." },
    { q: "Provide the medical term for 'the muscle layer of the heart.'", options: [], answer: ["Myocardium"], type: "text", category: "Terminology", section: "Terminology", rationale: "Myo- (muscle) + -cardium (heart)." },
    { q: "Provide the medical term for 'any disease of the kidneys.'", options: [], answer: ["Nephropathy"], type: "text", category: "Terminology", section: "Terminology", rationale: "Nephr- (kidney) + -pathy (disease)." },
    { q: "Provide the medical term for 'excessive production of urine.'", options: [], answer: ["Polyuria"], type: "text", category: "Terminology", section: "Terminology", rationale: "Poly- (many) + -uria (urine)." },
    { q: "Provide the medical term for 'difficulty breathing when lying flat.'", options: [], answer: ["Orthopnea"], type: "text", category: "Terminology", section: "Terminology", rationale: "Often seen in CHF patients." },
    { q: "Provide the medical term for 'a respiratory rate that is slower than normal.'", options: [], answer: ["Bradypnea"], type: "text", category: "Terminology", section: "Terminology", rationale: "Brady- (slow) + -pnea (breathing)." },
    { q: "Provide the medical term for 'a respiratory rate that is faster than normal.'", options: [], answer: ["Tachypnea"], type: "text", category: "Terminology", section: "Terminology", rationale: "Tachy- (fast) + -pnea (breathing)." },
    { q: "Provide the medical term for 'excessive or profuse bleeding.'", options: [], answer: ["Hemorrhage"], type: "text", category: "Terminology", section: "Terminology", rationale: "Hemo- (blood) + -rrhage (bursting forth)." },

    // --- MEDICAL ---
    { q: "A 70-year-old male with a history of MI presents with extreme dyspnea, waking up gasping for air. You find him sitting bolt-upright, coughing up pink, frothy sputum. BP 190/104, HR 110, SpO2 84% on room air. Which of the following interventions are appropriate? (Select all that apply)", options: ["Placing the patient in a supine position", "Application of CPAP at 5-10 cmH2O", "Administration of Nitroglycerin (per protocol)", "High-flow oxygen via Non-rebreather mask", "Administration of Albuterol via nebulizer"], answer: ["Application of CPAP at 5-10 cmH2O", "Administration of Nitroglycerin (per protocol)", "High-flow oxygen via Non-rebreather mask"], type: "multiple", category: "Cardiovascular", section: "Medical", rationale: "Acute Decompensated Heart Failure (ADHF) requires CPAP to move alveolar fluid and Nitro to reduce preload. Supine positioning worsens orthopnea." },
    { q: "A patient with a history of chronic COPD presents with worsening fatigue and shortness of breath. Which of the following clinical findings specifically indicate Right-Sided Heart Failure (Cor Pulmonale)? (Select all that apply)", options: ["Jugular Venous Distension (JVD)", "Bilateral crackles (rales) in the lung bases", "Dependent peripheral edema", "Pink frothy sputum", "Ascites (abdominal swelling)"], answer: ["Jugular Venous Distension (JVD)", "Dependent peripheral edema", "Ascites (abdominal swelling)"], type: "multiple", category: "Cardiovascular", section: "Medical", rationale: "Right failure causes systemic backup (JVD, edema, ascites). Left failure causes pulmonary backup (crackles, sputum)." },
    { q: "How does CPAP improve oxygenation in pulmonary edema?", options: ["Increasing HR", "Forcing fluid out of alveoli and into capillaries", "Improves blood pressure", "Causing vasodilation"], answer: ["Forcing fluid out of alveoli and into capillaries"], type: "single", category: "Respiratory", section: "Medical", rationale: "CPAP uses pressure to push fluid from the air sacs back into the bloodstream." },
    { q: "A patient has stroke symptoms that resolve in 45 minutes. This was a:", options: ["Ischemic Stroke", "Hemorrhagic Stroke", "TIA", "Hypoglycemia"], answer: ["TIA"], type: "single", category: "Neurologic", section: "Medical", rationale: "Transient Ischemic Attacks resolve completely within 24 hours." },
    { q: "Cushing's Syndrome is characterized by:", options: ["Moon-face and buffalo hump", "Extreme weight loss", "Low blood glucose", "Hypotension"], answer: ["Moon-face and buffalo hump"], type: "single", category: "Endocrine", section: "Medical", rationale: "Caused by hyperadrenalism (excess cortisol)." },
    { q: "A patient with 'tearing' back pain and unequal BPs in arms likely has:", options: ["Heart Attack", "Aortic Dissection", "Kidney Stones", "Gallstones"], answer: ["Aortic Dissection"], type: "single", category: "Cardiovascular", section: "Medical", rationale: "Unequal BP and tearing pain are classic for dissection." },
    ...
    { q: "Which Class of Hemorrhage is defined by 30-40% blood loss and a significant drop in systolic BP?", options: ["Class I", "Class II", "Class III", "Class IV"], answer: ["Class III"], type: "single", category: "Bleeding", section: "Trauma", rationale: "Class III involves marked tachycardia and hypotension as compensation fails." },
    { q: "Beck's Triad (JVD, muffled heart sounds, and narrowing pulse pressure) indicates:", options: ["Tension Pneumothorax", "Cardiac Tamponade", "Hemothorax", "Commotio Cordis"], answer: ["Cardiac Tamponade"], type: "single", category: "Chest", section: "Trauma", rationale: "Cardiac Tamponade occurs when fluid fills the pericardial sac, compressing the heart." },
    { q: "Referred pain to the left shoulder (Kehr's sign) is a classic indicator of injury to which organ?", options: ["Liver", "Spleen", "Kidneys", "Pancreas"], answer: ["Spleen"], type: "single", category: "Abdominal", section: "Trauma", rationale: "Splenic blood irritates the phrenic nerve, referred to the left shoulder." },
    { q: "What are the '6 Ps' of musculoskeletal assessment? (Select all that apply)", options: ["Pain", "Paresthesia", "Pulselessness", "Pallor", "Paralysis", "Pressure"], answer: ["Pain", "Paresthesia", "Pulselessness", "Pallor", "Paralysis", "Pressure"], type: "multiple", category: "Ortho", section: "Trauma", rationale: "These are critical for identifying Compartment Syndrome or neurovascular compromise." },
    { q: "The 'Lethal Triad' in trauma consists of which three conditions? (Select all that apply)", options: ["Acidosis", "Coagulopathy", "Hypothermia", "Hypertension"], answer: ["Acidosis", "Coagulopathy", "Hypothermia"], type: "multiple", category: "Bleeding", section: "Trauma", rationale: "Acidosis, Coagulopathy, and Hypothermia are a self-reinforcing cycle of death in major trauma." },
    { q: "A patient with a head injury presents with Hypertension, Bradycardia, and Irregular respirations. This is:", options: ["Beck's Triad", "Cushing's Triad", "Virchow's Triad", "The Bends"], answer: ["Cushing's Triad"], type: "single", category: "Head/Spine", section: "Trauma", rationale: "Cushing's Triad is a late sign of significantly increased intracranial pressure (ICP)." },
    { q: "A cold-water drowning patient is not considered dead until they are:", options: ["Warm and dead", "Pulseless for 30 mins", "Core temp reaches 90F", "No shock advised"], answer: ["Warm and dead"], type: "single", category: "Environmental", section: "Trauma", rationale: "Hypothermia protects vital organs; resuscitation must continue until the patient is warmed." },
    { q: "Which gas law explains decompression sickness ('The Bends') in divers?", options: ["Boyle's Law", "Henry's Law", "Dalton's Law", "Charles's Law"], answer: ["Henry's Law"], type: "single", category: "Environmental", section: "Trauma", rationale: "Henry's Law states that gas solubility is proportional to the partial pressure." },
    { q: "What is the primary pathophysiology behind 'Crush Syndrome'?", options: ["Immediate cardiac arrest", "Release of toxic metabolic byproducts after pressure is removed", "External hemorrhage", "Nerve death"], answer: ["Release of toxic metabolic byproducts after pressure is removed"], type: "single", category: "Soft-Tissue", section: "Trauma", rationale: "Releasing pressure allows myoglobin and potassium to flood the system." },
    { q: "What is the formula for Kinetic Energy in relation to trauma?", options: ["Mass x Velocity", "1/2 Mass x Velocity Squared", "Weight x Gravity", "Mass / Velocity"], answer: ["1/2 Mass x Velocity Squared"], type: "single", category: "Overview", section: "Trauma", rationale: "Velocity has a much greater impact on energy than mass because it is squared." },
    { q: "Which 'collision' in an MVC is responsible for a 'torn aorta'?", options: ["The Car collision", "The Body collision", "The Organ collision", "The Secondary collision"], answer: ["The Organ collision"], type: "single", category: "Overview", section: "Trauma", rationale: "The 3rd collision involves the heart/aorta moving forward after the chest wall has stopped." },
    { q: "A burn that is red, painful, and has blisters is classified as:", options: ["Superficial", "Partial-thickness", "Full-thickness", "Deep-thickness"], answer: ["Partial-thickness"], type: "single", category: "Soft-Tissue", section: "Trauma", rationale: "Partial-thickness (2nd degree) burns involve the epidermis and part of the dermis." },
    { q: "Which eye injury involves the feeling of 'a curtain being pulled over the field of vision'?", options: ["Hyphema", "Retinal Detachment", "Blowout Fracture", "Corneal Abrasion"], answer: ["Retinal Detachment"], type: "single", category: "Face/Neck", section: "Trauma", rationale: "This is a classic painless symptom of the retina separating from the back of the eye." },
    { q: "Cerebral blood flow is determined by which two factors?", options: ["BP and Heart Rate", "MAP and ICP", "Pulse Pressure and EtCO2", "GCS and Respiratory Rate"], answer: ["MAP and ICP"], type: "single", category: "Head/Spine", section: "Trauma", rationale: "Cerebral Perfusion Pressure (CPP) = Mean Arterial Pressure (MAP) - Intracranial Pressure (ICP)." },
    { q: "What is the immediate field treatment for a tension pneumothorax with signs of shock?", options: ["Occlusive dressing", "Needle Decompression", "High-flow O2 only", "Intubation"], answer: ["Needle Decompression"], type: "single", category: "Chest", section: "Trauma", rationale: "Needle decompression is an AEMT skill to relieve pressure on the heart and great vessels." },
    { q: "A 'Scaphoid' (hollow) abdomen in trauma suggests:", options: ["Ruptured Spleen", "Diaphragmatic Rupture", "Internal bleeding", "Evisceration"], answer: ["Diaphragmatic Rupture"], type: "single", category: "Abdominal", section: "Trauma", rationale: "Contents moving from the abdomen into the chest leave a hollow appearance." },
    { q: "What is the priority treatment for an open pelvic fracture?", options: ["Splint the legs", "Apply a pelvic binder", "Apply a tourniquet", "Apply a traction splint"], answer: ["Apply a pelvic binder"], type: "single", category: "Ortho", section: "Trauma", rationale: "Pelvic binders reduce internal volume and stabilize the fracture to limit bleeding." },
    { q: "What is the target Mean Arterial Pressure (MAP) for 'permissive hypotension' in internal trauma?", options: ["40-50 mmHg", "60-65 mmHg", "80-90 mmHg", "110-120 mmHg"], answer: ["60-65 mmHg"], type: "single", category: "Shock", section: "Trauma", rationale: "Targeting a lower MAP (60-65) helps maintain vital perfusion without 'popping the clot'." },
    { q: "A patient in 'Heat Stroke' is distinguished by which clinical finding?", options: ["Tachycardia", "Hot skin", "Altered Mental Status", "Muscle cramps"], answer: ["Altered Mental Status"], type: "single", category: "Environmental", section: "Trauma", rationale: "CNS dysfunction is the hallmark differentiator of Heat Stroke." },
    { q: "A patient with a traumatic brain injury (TBI) presents with a 'blown' pupil on the right side. This is:", options: ["Oculomotor nerve compression", "Optic nerve damage", "Sympathetic surge", "Normal variation"], answer: ["Oculomotor nerve compression"], type: "single", category: "Head/Spine", section: "Trauma", rationale: "Increased ICP compresses the third cranial nerve." },
    { q: "In the 6 Ps, which finding is typically the LATEST to develop?", options: ["Pain", "Pallor", "Pulselessness", "Paresthesia"], answer: ["Pulselessness"], type: "single", category: "Ortho", section: "Trauma", rationale: "Pulselessness is a very late sign of compartment syndrome or arterial injury." },
    { q: "A patient's toes fan out when the sole of the foot is stroked. In an adult, this is called:", options: ["Cushing's sign", "Babinski's sign", "Kehr's sign", "Murphy's sign"], answer: ["Babinski's sign"], type: "single", category: "Head/Spine", section: "Trauma", rationale: "A positive Babinski reflex in an adult indicates upper motor neuron or brain injury." },
    ...
    // --- OB/GYN & PEDIATRICS ---
    { q: "A patient in her 3rd trimester presents with painless, bright red vaginal bleeding. This is most likely:", options: ["Abruptio Placentae", "Placenta Previa", "Ectopic Pregnancy", "Preeclampsia"], answer: ["Placenta Previa"], type: "single", category: "Obstetrics", section: "OBPeds", rationale: "Placenta Previa is characterized by painless, bright red bleeding." },
    { q: "Which finding differentiates Eclampsia from Preeclampsia?", options: ["Hypertension", "Proteinuria", "Seizures", "Peripheral Edema"], answer: ["Seizures"], type: "single", category: "Obstetrics", section: "OBPeds", rationale: "Eclampsia is defined as the onset of seizures in a patient with preeclampsia." },
    { q: "During delivery, the infant's head emerges but the shoulders become stuck. This is known as:", options: ["Nuchal Cord", "Breech Presentation", "Shoulder Dystocia", "Prolapsed Cord"], answer: ["Shoulder Dystocia"], type: "single", category: "Obstetrics", section: "OBPeds", rationale: "Shoulder dystocia occurs when the fetal shoulders cannot pass the symphysis pubis." },
    { q: "What is the compression-to-ventilation ratio for neonatal resuscitation with two rescuers?", options: ["3:1", "15:2", "30:2", "5:1"], answer: ["3:1"], type: "single", category: "Neonatal", section: "OBPeds", rationale: "Neonatal resuscitation follows a 3:1 ratio (90 compressions and 30 breaths per minute)." },
    ...
    { q: "The 'Pediatric Assessment Triangle' (PAT) consists of which three elements? (Select all that apply)", options: ["Appearance", "Work of Breathing", "Circulation to Skin", "Blood Pressure"], answer: ["Appearance", "Work of Breathing", "Circulation to Skin"], type: "multiple", category: "Pediatrics", section: "OBPeds", rationale: "PAT is a visual assessment of Appearance, Breathing, and Circulation." },
    { q: "A 3-year-old presents with a high fever, drooling, and is sitting in a 'tripod' position. You should suspect:", options: ["Croup", "Epiglottitis", "Asthma", "Bronchiolitis"], answer: ["Epiglottitis"], type: "single", category: "Pediatrics", section: "OBPeds", rationale: "Drooling and tripod position are classic indicators of Epiglottitis, a life-threatening airway emergency." },
