const quizData = [
   ...
   // --- MEDICAL TERMINOLOGY (OPEN TEXT) ---
    { q: "Provide the medical term for 'a heart rate below 60 beats per minute.'", options: [], answer: ["Bradycardia"], type: "text", category: "Cardiology", section: "Terminology", rationale: "Brady- (slow) + -cardia (heart)." },
    { q: "Provide the medical term for 'a heart rate above 100 beats per minute.'", options: [], answer: ["Tachycardia"], type: "text", category: "Cardiology", section: "Terminology", rationale: "Tachy- (fast) + -cardia (heart)." },
    { q: "Provide the medical term for 'difficulty or labored breathing.'", options: [], answer: ["Dyspnea"], type: "text", category: "Respiratory", section: "Terminology", rationale: "Dys- (difficult) + -pnea (breathing)." },
    { q: "Provide the medical term for 'the absence of breathing.'", options: [], answer: ["Apnea"], type: "text", category: "Respiratory", section: "Terminology", rationale: "A- (without) + -pnea (breathing)." },
    { q: "Provide the medical term for 'vomiting blood.'", options: [], answer: ["Hematemesis"], type: "text", category: "Gastrointestinal", section: "Terminology", rationale: "Hemat- (blood) + -emesis (vomiting)." },
    { q: "Provide the medical term for 'blood in the urine.'", options: [], answer: ["Hematuria"], type: "text", category: "Genitourinary", section: "Terminology", rationale: "Hemat- (blood) + -uria (urine)." },
    { q: "Provide the medical term for 'enlargement of the liver.'", options: [], answer: ["Hepatomegaly"], type: "text", category: "Gastrointestinal", section: "Terminology", rationale: "Hepat- (liver) + -megaly (enlarged)." },
    { q: "Provide the medical term for 'inflammation of the gallbladder.'", options: [], answer: ["Cholecystitis"], type: "text", category: "Gastrointestinal", section: "Terminology", rationale: "Chole- (bile) + cyst- (sac) + -itis (inflammation)." },
    { q: "Provide the medical term for 'excessive sweating.'", options: [], answer: ["Diaphoresis"], type: "text", category: "General", section: "Terminology", rationale: "Used often to describe clinical signs of shock or cardiac events." },
    { q: "Provide the medical term for 'blood in the chest cavity.'", options: [], answer: ["Hemothorax"], type: "text", category: "Trauma", section: "Terminology", rationale: "Hemo- (blood) + -thorax (chest)." },
    { q: "Provide the medical term for 'low levels of oxygen in the tissues.'", options: [], answer: ["Hypoxia"], type: "text", category: "Respiratory", section: "Terminology", rationale: "Hypo- (low) + oxia (oxygen)." },
    { q: "Provide the medical term for 'bluish discoloration of the skin due to low oxygen.'", options: [], answer: ["Cyanosis"], type: "text", category: "Skin", section: "Terminology", rationale: "Cyan- (blue) + -osis (condition)." },
    { q: "Provide the medical term for 'a new surgical opening in the stomach.'", options: [], answer: ["Gastrostomy"], type: "text", category: "Gastrointestinal", section: "Terminology", rationale: "Gastr- (stomach) + -stomy (new opening)." },
    { q: "Provide the medical term for 'the muscle layer of the heart.'", options: [], answer: ["Myocardium"], type: "text", category: "Cardiology", section: "Terminology", rationale: "Myo- (muscle) + -cardium (heart)." },
    { q: "Provide the medical term for 'any disease of the kidneys.'", options: [], answer: ["Nephropathy"], type: "text", category: "Genitourinary", section: "Terminology", rationale: "Nephr- (kidney) + -pathy (disease)." },
    { q: "Provide the medical term for 'excessive production of urine.'", options: [], answer: ["Polyuria"], type: "text", category: "Genitourinary", section: "Terminology", rationale: "Poly- (many) + -uria (urine)." },
    { q: "Provide the medical term for 'difficulty breathing when lying flat.'", options: [], answer: ["Orthopnea"], type: "text", category: "Respiratory", section: "Terminology", rationale: "Often seen in CHF patients." },
    { q: "Provide the medical term for 'a respiratory rate that is slower than normal.'", options: [], answer: ["Bradypnea"], type: "text", category: "Respiratory", section: "Terminology", rationale: "Brady- (slow) + -pnea (breathing)." },
    { q: "Provide the medical term for 'a respiratory rate that is faster than normal.'", options: [], answer: ["Tachypnea"], type: "text", category: "Respiratory", section: "Terminology", rationale: "Tachy- (fast) + -pnea (breathing)." },
    { q: "Provide the medical term for 'excessive or profuse bleeding.'", options: [], answer: ["Hemorrhage"], type: "text", category: "Trauma", section: "Terminology", rationale: "Hemo- (blood) + -rrhage (bursting forth)." },
